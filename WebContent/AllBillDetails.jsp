...
<div class="datatable_page container">
                                    ...
                                    <div class="ard-block p-t-25">
                                        ...
                                        <table class="table  table-striped table-bordered table-hover" id="ample_1">
                                            ...
                                            <tbody>
                                            <% DAO dao = new DAO();
                                            	ResultSet rs = dao.getBillDetails();
                                            	int h = 0;
                                            	while(rs.next())
                                            	{
                                            %>
                                                <tr>
                                                <form action="./TesterController" method="Post">
                                                    <td><%=++h %></td>
                                                   <td><%=rs.getString("c_date") %></td>
                                                    ...
                                                    <input type="hidden" name="billnobill" value='<%=rs.getString("bill_no") %>' >
                                                  
                                                    <td><input name="btnclick22" type="submit" value="Click Here"></td>
                                                     </form>
                                                </tr>
                                                <%} %>
